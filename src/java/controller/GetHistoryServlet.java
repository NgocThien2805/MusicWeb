...
public class GetHistoryServlet extends HttpServlet {
    ...
    """;
            ...
            ps.setInt(1, Integer.parseInt(userId)); // Kiểm tra like
            ps.setInt(2, Integer.parseInt(userId)); // Lọc theo user_id
            ...
            while (rs.next()) {
                ...
                song.put("liked", rs.getInt("liked") == 1); // Thêm thông tin liked
