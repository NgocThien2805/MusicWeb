            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <%
                            // Chỉ hiển thị "Up songs" nếu userId không phải là "1"
                            if (username != null && !userId.equals("1")) { // Nếu đã đăng nhập và userId != "1"
                        %>
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/SongServlet">Up songs</a>
                        </li>
                        <%
                            } else if (username == null) { // Nếu chưa đăng nhập
                        %>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <%
                                    if (userId.equals("1")) { // Nếu userId == "1"
                                %>
