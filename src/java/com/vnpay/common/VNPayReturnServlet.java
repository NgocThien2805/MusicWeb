...
public class VNPayReturnServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String userId = (String) session.getAttribute("user_id"); // Lấy username từ session

        // 🏆 Bước 1: Kiểm tra trạng thái giao dịch từ VNPAY
        String vnp_ResponseCode = request.getParameter("vnp_ResponseCode");

        if ("00".equals(vnp_ResponseCode)) { // 🏆 Bước 2: Cập nhật tài khoản thành Premium trong database
